...
public class TenThang extends JDialog{
    ...
    public TenThang(int ten, int diem, int mucchoi) {
        ...
        lbl2.setIcon(new ImageIcon(getClass().getResource("/img/mypciture.JPG")));
        p.add(lbl2);
        
        JLabel lbl3 = new JLabel();
        lbl3.setBounds(195, 125, 150, 131);
        lbl3.setIcon(new ImageIcon(getClass().getResource("/img/mypicture.JPG")));
        p.add(lbl3);
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
             ...
             if(ten[11].equals("")) ten[11]="no name";
             Diem[11]=diem;
             int o;
             for(o=1;o<=11;o++)
                 if(diem>Diem[o]) break;
             for(i=10;i>o;i--)
             {
                 ten[i]=ten[i-1];
                 Diem[i]=Diem[i-1];
